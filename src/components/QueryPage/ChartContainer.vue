...
export default {
    ...
    data() {
        return {
            uniqueTooltipId: this.$helper.lodash.uniqueId('tooltip_'),
            dataPoint: null,
            chartToolHeight: 0,
        }
    },
    computed: {
        ...
        lineChartOptions() {
            ...
            return this.$helper.lodash.deepMerge(this.chartOptions, lineOptions)
        },
        scatterChartOptions() {
            return this.$helper.lodash.deepMerge(this.chartOptions, {
                hover: {
                    mode: 'nearest',
                },
                tooltips: {
    ...
    methods: {
        ...
        getDefFileName() {
            return `MaxScale ${this.selectedChart} Chart - ${this.$helper.dateFormat({
                value: new Date(),
